...
class AssetPickerTextDelegate {
  ...
  /// 未支持的资源类型的字段
  String get unSupportedAssetType => 'Định dạng không được hỗ trợ';

  /// "Unable to access all assets in album".
  String get unableToAccessAll => 'Không thể truy cập tất cả ảnh';

  String get viewingLimitedAssetsTip => 'Ứng dụng chỉ có thể truy cập một số ảnh hoặc album';

  String get changeAccessibleLimitedAssets => 'Cài đặt ảnh được cho phép';

  String get accessAllTip => 'Bạn đã cài đặt chỉ cho phép truy cập một số ảnh nhất định.\n'
      'Đề xuất cho phép truy cập tất cả ảnh';

  String get goToSystemSettings => 'Đi tới cài đặt';

  /// "Continue accessing some assets".
  String get accessLimitedAssets => 'Tiếp tục với ảnh được chọn';

  String get accessiblePathName => 'Ảnh/Video được chọn';
